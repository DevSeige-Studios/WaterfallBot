    ...
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(sub =>
            sub.setName('emoji')
                ...
                .addStringOption(opt =>
                    opt.setName('emoji1')
                        .setNameLocalizations(commandMeta.generate.option_emoji1_name || {})
                        .setDescription('First emoji')
                        .setDescriptionLocalizations(commandMeta.generate.option_emoji1_description || {})
                        .setRequired(true)
                        .setMaxLength(10)
                )
                .addStringOption(opt =>
                    opt.setName('emoji2')
                        .setNameLocalizations(commandMeta.generate.option_emoji2_name || {})
                        .setDescription('Second emoji')
                        .setDescriptionLocalizations(commandMeta.generate.option_emoji2_description || {})
                        .setRequired(true)
                        .setMaxLength(10)
                )
        ),
